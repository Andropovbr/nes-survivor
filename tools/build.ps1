...
function Build-Rom {
    ...
    $cModules = @("main", "game", "input", "rng", "animation", "metasprite", "player", "soldier_animation_data", "weapon_sword")
...
function Run-Tests {
    ...
    Invoke-Checked "cl65" @("-t", "sim6502", "--standard", "c99", "--warnings-as-errors", "-DUNIT_TEST", "-I", "include", "-o", $testBinary, "tests/test_logic.c", "src/input.c", "src/rng.c", "src/animation.c", "src/metasprite.c", "src/player.c", "src/soldier_animation_data.c", "src/weapon_sword.c")
